...
LOCAL_MODULE := android.hardware.power-service.xiaomi-sirius-libperfmgr
LOCAL_INIT_RC := android.hardware.power-service.xiaomi-sirius-libperfmgr.rc
LOCAL_MODULE_TAGS := optional
LOCAL_VENDOR_MODULE := true
LOCAL_VINTF_FRAGMENTS := android.hardware.power-service.xiaomi-sirius.xml
